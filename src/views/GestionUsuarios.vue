  ...
  <div class="modulo">
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="guardar">
            <input v-model="form.login" placeholder="Usuario" required><br><br>
        ...
        <table>
            ...
            <tbody>
                <tr v-for="u in usuarios" :key="u.login">
                    ...
                    <td>
                        <button @click="borrar(u.login)" class="btn-borrar">Eliminar</button>
                    </td>
                </tr>
        </tbody>
        </table>
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="actualizar">
            <input v-model="formUpdate.login" placeholder="Usuario" required><br><br>
