...
const cargar = async () => { 
  estadoUsuarios.value = await estadosUsuarioServicios.listar(); 
};
  ...
  <div class="modulo">
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="guardar">
            ...
            <input v-model="form.permite_acceso" placeholder="Permitir acceso" required><br><br>
    ...
    <div class="contenido">
        <table>
            ...
            <tbody>
                <tr v-for="e in estadoUsuarios" :key="e.id">
                    <td>{{ e.id }}</td>
                    <td>{{ e.nombre }}</td>
                    <td>{{ e.permite_acceso }}</td>
                    <td>{{ e.descripcion }}</td>
                    <td>
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="actualizar">
            ...
            <input v-model="formUpdate.permite_acceso" placeholder="Permitir acceso" required><br><br>
