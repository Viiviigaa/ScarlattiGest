...
const cargar = async () => { 
  departamentos.value = await departamentosServicios.listar(); 
};
  ...
  <div class="modulo">
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="guardar">
            ...
            <input v-model="form.ubicacion" placeholder="Ubicacion planta" required><br><br>
            <input v-model="form.correo_contacto" placeholder="Correo contacto" required><br><br>
        ...
        <table>
            ...
            <tbody>
                <tr v-for="d in departamentos" :key="d.id">
                    ...
                    <td>
                        <button @click="borrar(d.id)" class="btn-borrar">Eliminar</button>
                    </td>
                </tr>
        </tbody>
        </table>
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="actualizar">
            ...
            <input v-model="formUpdate.ubicacion" placeholder="Ubicacion" required><br><br>
            <input v-model="formUpdate.correo_contacto" placeholder="Correo" required><br><br>
