...
const borrar = async (id) => {
    if (confirm("¿Desea cancelar las reservas activas de este profesor?")) {
        await rolesServicios.eliminar(id);
        cargar();
    }
};
  ...
  <div class="modulo">
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="guardar">
            ...
            <input v-model="form.ubicacion" placeholder="Nivel de privilegio" required><br><br>
            <input v-model="form.descripcion" placeholder="Descripcion" required><br><br>
        ...
        <table>
            ...
            <tbody>
                <tr v-for="r in roles" :key="r.id">
                    ...
                    <td>{{ r.descripcion }}</td>
                    <td>
                        <button @click="borrar(r.id)" class="btn-borrar">Eliminar</button>
                    </td>
                </tr>
        </tbody>
        </table>
    ...
    <div class="contenido">
        ...
        <form @submit.prevent="actualizar">
            ...
            <input v-model="formUpdate.nivel_privilegio" placeholder="Nivel de privilegio" required><br><br>
            <input v-model="formUpdate.descripcion" placeholder="Descripcion" required><br><br>
