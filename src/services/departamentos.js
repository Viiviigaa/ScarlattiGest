const API_URL = "http://44.207.19.239:3000/departamentos?zusuario=Victor";
const BASE_URL = "http://44.207.19.239:3000/departamentos";
const zID = "?zusuario=Victor";

export const departamentosServicios = {
    async listar() {
