const API_URL = "http://44.207.19.239:3000/estados_incidencia?zusuario=Victor";
const BASE_URL = "http://44.207.19.239:3000/estados_incidencia";
const zID = "?zusuario=Victor";

export const estadosIncidenciasService = {
    async listar() {
